...
const ProjectGrid = ({ projects }) => {
  ...
  const getProjectImage = (project) => {
    const scheme = project.scheme 
      ...
      : (project.sector ? project.sector.toLowerCase() : '');
    ...
    return `https://source.unsplash.com/500x300/?${encodeURIComponent(project.scheme || 'project')}`;
  };
    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 p-2">
        {projects.map((project) => {
          ...
          const scheme = project.scheme || project.scheme_name || project.sector;
            ...
            >
              ...
              <div className="p-5 bg-white">
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className={`px-3 py-1 rounded-full text-xs font-medium ${getStatusColor(status)} shadow-sm`}>
                    {status}
                  </span>
                </div>
              </div>
