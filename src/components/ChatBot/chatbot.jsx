...
const ChatBot = ({
  ...
  return (
    <div
      className="fixed bottom-0 right-0 z-50 font-sans w-[90vw] sm:w-auto"
      style={{
    ...
    >
      ...
      text-black rounded-full p-5 sm:p-4 shadow-lg hover:shadow-xl 
    ...
    `}
      ...
      <div
        className={`
          absolute left-0 right-0 mx-auto bottom-0 sm:bottom-20
          w-[90vw] sm:w-80 max-w-[90vw] sm:max-w-none
