...
export default function PostGrievanceModal({ isOpen, onClose, onSuccess }) {
  ...
  const categories = [
    'Agriculture and Allied Services', 'Rural Development', 'Irrigation and Flood Control',
  ];

  const departments = [
    'Public Works Department', 'Health Department', 'Education Department',
    'Water Board', 'Electricity Board', 'Transport Department', 'Environment Department'
  ];
        ...
        {isOpen && (
          <div className="fixed inset-0 bg-black bg-opacity-10 z-50 flex items-center justify-center p-2 sm:p-4">
            <motion.div
              ...
              className="bg-white rounded-2xl sm:rounded-3xl shadow-xl w-full max-w-lg sm:max-w-5xl max-h-[95vh] sm:max-h-[90vh] overflow-hidden flex flex-col"
            >
              {/* Header */}
              <div className="relative bg-white px-4 py-4 sm:px-8 sm:py-6 border-b border-gray-200">
                <button
                  type="button"
                  onClick={onClose}
              ...
              <div className="overflow-y-auto max-h-[calc(95vh-120px)] sm:max-h-[calc(90vh-180px)]">
                <form onSubmit={handleSubmit} className="p-4 sm:p-8">
                  {error && (
                    <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 sm:px-6 sm:py-4 rounded-2xl mb-6 sm:mb-8 flex items-start text-sm sm:text-base">
                      <svg
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                      <div>
                        ...
                        <input
                          ...
                          onFocus={(e) => e.target.style.borderColor = '#72e3ad'}
                    ...
                    <div className="space-y-4 sm:space-y-6">
                      <div>
                        ...
                        <div className="flex justify-between mt-1">
                          <p className="text-xs text-gray-500">Brief summary for quick understanding</p>
                          <p className="text-xs text-gray-500">{formData.short_description.length}/100</p>
                        </div>
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-black mb-2">
                  ...
                  <div className="bg-gray-50 rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8">
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-2xl p-4 sm:p-8 text-center bg-white hover:border-gray-400 transition-colors">
                      ...
                      <label htmlFor="file-upload" className="cursor-pointer">
                        <div className="flex flex-col items-center">
                          ...
                          <p className="text-black font-semibold mb-1">Upload Supporting Image</p>
                          <p className="text-sm text-gray-600">PNG, JPG, JPEG up to 10MB</p>
                          <p className="text-xs text-gray-500 mt-2">Optional but recommended for faster resolution</p>
                        </div>
                      </label>
                    </div>
                    {image && (
                      <div className="mt-3 sm:mt-4 p-3 sm:p-4 bg-white border border-gray-200 rounded-xl flex items-center">
                    ...
                    {image && (
                      <img
                        ...
                        alt="Preview"
                        className="w-full max-w-xs rounded-xl mt-3 sm:mt-4 mx-auto"
                  ...
                  <div className="flex flex-col sm:flex-row justify-end gap-3 sm:gap-4 pt-4 sm:pt-6">
                    ...
                    <button
                      ...
                      onMouseLeave={(e) => e.target.style.backgroundColor = '#72e3ad'}
                    >
                      {loading ? (
                        <>
        ...
        {showSuccessModal && (
          <div className="fixed inset-0 bg-black bg-opacity-15 z-[60] flex items-center justify-center p-2 sm:p-4">
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-2xl max-w-xs sm:max-w-md w-full p-6 sm:p-8 text-center"
            >
              <div className="w-16 h-16 mx-auto mb-6 rounded-full flex items-center justify-center" style={{ backgroundColor: '#72e3ad' }}>
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-black mb-4">Grievance Submitted!</h3>
              <p className="text-gray-600 mb-6">
                Your grievance has been successfully submitted. We'll review it and get back to you soon.
              </p>
              <button
        ...
        {showFailureModal && (
          <div className="fixed inset-0 bg-black bg-opacity-15 z-[60] flex items-center justify-center p-2 sm:p-4">
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-black mb-4">Submission Failed</h3>
              <p className="text-gray-600 mb-6">
